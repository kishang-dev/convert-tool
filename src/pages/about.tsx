            ...
            <main className="flex-1 pt-32 pb-20">
                ...
                <section className="px-4 sm:px-6 mb-20 text-center">
                    <div className="max-w-3xl mx-auto">
                        <p className="text-xs text-[#555] uppercase tracking-widest font-medium mb-4">Our Mission</p>
                        <h1 className="text-3xl sm:text-5xl font-bold tracking-tight mb-6">
                            Revolutionizing modern workflows
                        </h1>
                        <p className="text-[#555] text-sm leading-relaxed max-w-2xl mx-auto">
                    ...
                    <div className="max-w-5xl mx-auto px-4 sm:px-6">
                        <div className="grid md:grid-cols-3 gap-6">
                            {[
                                ...
                                <div key={i} className="bg-[#111] border border-[#1a1a1a] rounded-xl p-6 hover:border-[#2a2a2a] transition-colors">
                                    <div className="bg-[#1a1a1a] border border-[#222] p-2.5 rounded-lg inline-block mb-4">
                                        <v.icon size={17} className="text-[#888]" />
                                    </div>
                                    <h3 className="text-white font-semibold text-sm mb-2">{v.title}</h3>
                                    <p className="text-[#555] text-xs leading-relaxed">{v.desc}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <section className="py-20 px-4 sm:px-6">
                    <div className="max-w-4xl mx-auto">
                        <div className="grid md:grid-cols-2 gap-12 items-start">
                            <div>
                                <p className="text-xs text-[#555] uppercase tracking-widest font-medium mb-2">Who We Are</p>
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                <div className="bg-[#111] border border-[#1a1a1a] rounded-xl p-6">
                                    ...
                                    <p className="text-xs text-[#555] uppercase tracking-widest">Countries Reached</p>
                                </div>
                                <div className="bg-[#111] border border-[#1a1a1a] rounded-xl p-6">
                                    <div className="flex items-center gap-3 mb-2">
                                        <Heart size={18} className="text-[#888]" />
                                        <span className="text-xl font-bold text-white">10M+</span>
                                    </div>
                                    <p className="text-xs text-[#555] uppercase tracking-widest">Files Converted</p>
                                </div>
                            </div>
                        </div>
                    </div>
