...
import { LuUpload as Upload, LuFileCode as FileCode, LuDownload as Download, LuArrowRight as ArrowRight, LuCircleCheck as CheckCircle } from "react-icons/lu";
...
export default function PdfToHtml() {
    ...
    const handleConvert = async () => {
        ...
        try {
            ...
            const response = await fileAPI.pdfToHtml(uploadedFile._id);
    ...
    const structuredData = {
        ...
        "@type": "WebApplication",
        "name": "PDF to HTML Converter Tools",
