                    ...
                    <Card variant="elevated" className="p-6 sm:p-8">
                        ...
                        <div className="relative mb-6">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-3 bg-[var(--surface)] dark:bg-[var(--surface)] text-[var(--text-faint)] dark:text-[var(--text-muted)] rounded">or register with email</span>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            {/* Name Input */}
                            <div>
                                <label htmlFor="name" className="block text-sm font-medium text-[var(--text-muted)] dark:text-[var(--text-muted)] mb-2">
                                    Full Name
                                </label>
