        ...
        <footer className="bg-[#0f172a] border-t border-white/5 pt-20 pb-10 px-6 font-sans">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    ...
                    {/* Tools Section */}
                    <div>
                        <h4 className="text-xs font-black text-white uppercase tracking-[0.2em] mb-8 opacity-60">Core Tools</h4>
                    ...
                    {/* Company Section */}
                    <div>
                        <h4 className="text-xs font-black text-white uppercase tracking-[0.2em] mb-8 opacity-60">Ecosystem</h4>
                        <ul className="space-y-4">
                            <li><Link href="/about" className="text-gray-400 hover:text-white text-sm font-bold uppercase tracking-wider transition-colors flex items-center gap-3">
                                <Info size={16} /> About Us
                            </Link></li>
                            <li><Link href="/contact" className="text-gray-400 hover:text-white text-sm font-bold uppercase tracking-wider transition-colors flex items-center gap-3">
                                <Mail size={16} /> Contact
                            </Link></li>
                            <li><Link href="/privacy" className="text-gray-400 hover:text-white text-sm font-bold uppercase tracking-wider transition-colors flex items-center gap-3">
                                <Shield size={16} /> Privacy
                            </Link></li>
                            <li><Link href="/terms" className="text-gray-400 hover:text-white text-sm font-bold uppercase tracking-wider transition-colors flex items-center gap-3">
                    ...
                    {/* Newsletter/Status */}
                    <div>
                        <h4 className="text-xs font-black text-white uppercase tracking-[0.2em] mb-8 opacity-60">System Status</h4>
