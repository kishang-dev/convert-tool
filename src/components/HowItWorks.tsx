    ...
    return (
        <section className="py-20 px-4 sm:px-6 border-t border-[#1a1a1a]">
            <div className="max-w-5xl mx-auto">
                {/* Header */}
                <div className="mb-12">
                    <p className="text-xs text-[#555] uppercase tracking-widest font-medium mb-2">How it works</p>
                    <h2 className="text-2xl sm:text-3xl font-bold text-white tracking-tight">Three steps to done</h2>
                </div>
                        ...
                        return (
                            ...
                            >
                                <div className="flex items-center justify-between mb-5">
                                    <div className="bg-[#1a1a1a] border border-[#2a2a2a] p-2.5 rounded-lg">
