    ...
    <div className="bg-white w-[794px] min-h-[1123px] resume-page box-sizing-border" style={{ fontFamily: 'DM Sans, sans-serif', borderTop: `6px solid ${c}` }}>
        ...
        <div className="flex px-12 py-6 gap-8">
            <main className="flex-1 space-y-5">
                ...
                <section>
                    <h2 className="text-[9px] font-bold uppercase tracking-[0.2em] mb-4 text-gray-600 ">Experience</h2>
                    <div className="space-y-5">
                        {data.experience.map((e: any, i: number) => (
                            <div key={i}>
                                <div className="flex justify-between items-baseline">
                                    <span className="text-sm font-semibold text-gray-800">{e.company}</span>
                                    <span className="text-[9px] text-gray-600 ">{e.startDate} – {e.endDate || 'Present'}</span>
                                </div>
                ...
                {data.projects?.length > 0 && (
                    <section>
                        <h2 className="text-[9px] font-bold uppercase tracking-[0.2em] mb-4 text-gray-600 ">Projects</h2>
                ...
                {data.publications?.length > 0 && (
                    <section>
                        <h2 className="text-[9px] font-bold uppercase tracking-[0.2em] mb-4 text-gray-600 ">Publications</h2>
                        <div className="space-y-3">
                            {data.publications.map((pub: any, i: number) => (
                                <div key={i}>
                                    <div className="flex justify-between"><span className="text-[11px] font-semibold text-gray-800">{pub.title}</span><span className="text-[9px]" style={{ color: c }}>{pub.date}</span></div>
                                    <p className="text-[10px] text-gray-500 mt-0.5">{pub.publisher} {pub.url ? `— ${pub.url}` : ''}</p>
                                </div>
                            ))}
                        </div>
                    </section>
                ...
                {data.volunteer?.length > 0 && (
                    <section>
                        <h2 className="text-[9px] font-bold uppercase tracking-[0.2em] mb-4 text-gray-600 ">Volunteer Experience</h2>
                        <div className="space-y-3">
                            {data.volunteer.map((vol: any, i: number) => (
                                <div key={i}>
                                    <div className="flex justify-between"><span className="text-[11px] font-semibold text-gray-800">{vol.role} at {vol.organization}</span><span className="text-[9px]" style={{ color: c }}>{vol.startDate} - {vol.endDate}</span></div>
                                    <p className="text-[10px] text-gray-500 mt-0.5">{vol.description}</p>
                                </div>
                            ))}
                        </div>
                    </section>
            ...
            <aside className="w-48 space-y-7">
                <section>
                    <h2 className="text-[9px] font-bold uppercase tracking-[0.2em] mb-3 text-gray-600 ">Education</h2>
                    {data.education.map((e: any, i: number) => (
                        <div key={i} className="mb-3">
                            ...
                            <div className="text-[9px] text-gray-600 ">{e.startDate} – {e.endDate}</div>
                        </div>
                    ))}
                </section>
                <section>
                    <h2 className="text-[9px] font-bold uppercase tracking-[0.2em] mb-3 text-gray-600 ">Skills</h2>
                ...
                {data.languages?.length > 0 && (
                    <section>
                        <h2 className="text-[9px] font-bold uppercase tracking-[0.2em] mb-3 text-gray-600 ">Languages</h2>
                        {data.languages.map((l: any, i: number) => (
                            <div key={i} className="flex justify-between text-[10px] mb-1">
                                ...
                                <span className="text-gray-600 ">{l.proficiency}</span>
                            </div>
                        ))}
                    </section>
                )}
                {data.certifications?.length > 0 && (
                    <section>
                        <h2 className="text-[9px] font-bold uppercase tracking-[0.2em] mb-3 text-gray-600 ">Certifications</h2>
                        {data.certifications.map((cert: any, i: number) => (
                            <div key={i} className="mb-2">
                                <div className="text-[9px] font-semibold text-gray-700">{cert.name}</div>
                                <div className="text-[9px] text-gray-600 ">{cert.issuer} · {cert.date}</div>
                            </div>
                        ))}
                    </section>
                )}
                {data.interests?.length > 0 && (
                    <section>
                        <h2 className="text-[9px] font-bold uppercase tracking-[0.2em] mb-3 text-gray-600 ">Interests</h2>
                        <p className="text-[10px] text-gray-500 ">{data.interests.join(' · ')}</p>
                    </section>
                )}
                {data.references?.length > 0 && (
                    <section>
                        <h2 className="text-[9px] font-bold uppercase tracking-[0.2em] mb-3 text-gray-600 ">References</h2>
                        {data.references.map((ref: any, i: number) => (
                            <div key={i} className="mb-2">
                                <div className="text-[9px] font-semibold text-gray-700">{ref.name}</div>
                                <div className="text-[9px] text-gray-600 ">{ref.position} · {ref.company}</div>
                                <div className="text-[8px] text-gray-500 ">{ref.contact}</div>
                            </div>
                        ))}
                    </section>
                )}
                    ...
                    {data.experience.map((e: any, i: number) => (
                        <div key={i} className="mb-5">
                            <div className="flex justify-between items-baseline">
                                ...
                                <span className="text-[10px] text-gray-600  italic">{e.startDate} – {e.endDate || 'Present'}</span>
                            </div>
            ...
            <div className="space-y-6">
                <section>
                    ...
                    {data.education.map((e: any, i: number) => (
                        <div key={i} className="mb-4">
                            ...
                            <div className="text-[10px] text-gray-600 ">{e.endDate}</div>
                        </div>
                    ))}
                </section>
                <section>
                ...
                {data.languages?.length > 0 && (
                    <section>
                        ...
                        {data.languages.map((l: any, i: number) => (
                            <div key={i} className="text-[11px] text-gray-600">{l.language} <span className="text-gray-600  italic">– {l.proficiency}</span></div>
                        ))}
                    </section>
                )}
                {data.certifications?.length > 0 && (
    ...
    <div className="bg-white w-[794px] min-h-[1123px] resume-page flex" style={{ fontFamily: 'DM Sans, sans-serif' }}>
        <aside className="w-[240px] flex-shrink-0 flex flex-col" style={{ background: c }}>
            <div className="p-8 pb-6">
                <div className="w-20 h-20 rounded-full bg-white/20 flex items-center justify-center text-gray-900  text-3xl font-bold mb-4">
                    {data.personalInfo.fullName.charAt(0)}
                </div>
                <h1 className="text-xl font-bold text-gray-900  leading-tight">{data.personalInfo.fullName}</h1>
                <p className="text-[10px] text-gray-900  mt-1 uppercase tracking-wider">{data.experience[0]?.position}</p>
            </div>
            <div className="px-8 py-5 bg-black/10 space-y-1">
                <div className="text-[9px] text-gray-900  uppercase tracking-wider mb-1">Contact</div>
                <div className="text-[10px] text-gray-900 ">{data.personalInfo.email}</div>
                <div className="text-[10px] text-gray-900 ">{data.personalInfo.phone}</div>
                <div className="text-[10px] text-gray-900 ">{data.personalInfo.address}</div>
                {data.personalInfo.linkedin && <div className="text-[10px] text-gray-900 ">{data.personalInfo.linkedin}</div>}
                {data.personalInfo.github && <div className="text-[10px] text-gray-900 ">{data.personalInfo.github}</div>}
            </div>
            <div className="px-8 py-5 space-y-5">
                <div>
                    <div className="text-[9px] text-gray-900  uppercase tracking-wider mb-2">Skills</div>
                    <div className="flex flex-wrap gap-1.5">
                        {data.skills.map((s: string, i: number) => (
                            <span key={i} className="text-[8px] px-2 py-0.5 rounded bg-white/15 text-gray-900  font-medium">{s}</span>
                        ))}
                    </div>
                </div>
                <div>
                    <div className="text-[9px] text-gray-900  uppercase tracking-wider mb-2">Education</div>
                    {data.education.map((e: any, i: number) => (
                        <div key={i} className="mb-3">
                            <div className="text-[10px] font-semibold text-gray-900 ">{e.school}</div>
                            <div className="text-[9px] text-gray-900 ">{e.degree}</div>
                            <div className="text-[9px] text-gray-900 ">{e.fieldOfStudy}</div>
                            <div className="text-[9px] text-gray-900 ">{e.endDate}</div>
                        </div>
                    ))}
                </div>
                {data.languages?.length > 0 && (
                    <div>
                        <div className="text-[9px] text-gray-900  uppercase tracking-wider mb-2">Languages</div>
                        {data.languages.map((l: any, i: number) => (
                            <div key={i} className="flex justify-between text-[9px] text-gray-900  mb-1">
                                <span>{l.language}</span><span className="text-gray-900 ">{l.proficiency}</span>
                            </div>
                        ))}
                    </div>
                )}
                {data.interests?.length > 0 && (
                    <div>
                        <div className="text-[9px] text-gray-900  uppercase tracking-wider mb-2">Interests</div>
                        <p className="text-[9px] text-gray-900  leading-relaxed">{data.interests.join(' · ')}</p>
                    </div>
                )}
            </div>
        </aside>
                    ...
                    <div className="space-y-1.5">
                        {data.awards.map((a: any, i: number) => (
                            <div key={i} className="flex justify-between text-[10px]">
                                ...
                                <span className="text-gray-600 ">{a.issuer} · {a.date}</span>
                            </div>
                        ))}
                    </div>
                </section>
...
const T_Executive = ({ data, primaryColor: c }: any) => (
    <div className="bg-white w-[794px] min-h-[1123px] resume-page" style={{ fontFamily: 'Inter, sans-serif' }}>
        <header className="px-14 py-10" style={{ background: c }}>
            <h1 className="text-4xl font-black text-gray-900  tracking-tight uppercase">{data.personalInfo.fullName}</h1>
            <p className="text-gray-900  text-sm font-medium mt-1 uppercase tracking-widest">{data.experience[0]?.position}</p>
            <div className="flex flex-wrap gap-x-8 mt-4 text-[10px] text-gray-900 ">
                    ...
                    {data.experience.map((e: any, i: number) => (
                        <div key={i} className="mb-5">
                            <div className="flex justify-between items-baseline mb-0.5">
                                ...
                                <span className="text-[9px] text-gray-600  font-medium">{e.startDate} – {e.endDate || 'Present'}</span>
                            </div>
                    ...
                    <section>
                        ...
                        {data.awards.map((a: any, i: number) => (
                            <div key={i} className="mb-2">
                                ...
                                <div className="text-[9px] text-gray-600 ">{a.issuer} · {a.date}</div>
                            </div>
                        ))}
                    </section>
                )}
...
const T_Minimalist = ({ data, primaryColor: c }: any) => (
    <div className="bg-white w-[794px] min-h-[1123px] resume-page px-24 py-16" style={{ fontFamily: 'DM Sans, sans-serif' }}>
        <header className="mb-14">
            ...
            <div className="flex gap-6 text-[10px] text-gray-600  tracking-wider">
                <span>{data.personalInfo.email}</span>
                <span>{data.personalInfo.phone}</span>
                {data.personalInfo.linkedin && <span>{data.personalInfo.linkedin}</span>}
            </div>
        ...
        <div className="space-y-12">
            ...
            <div className="grid grid-cols-12 gap-12">
                <div className="col-span-7 space-y-10">
                    <section>
                        <div className="text-[8px] uppercase tracking-[0.35em] text-gray-700  mb-5 font-medium">experience</div>
                        {data.experience.map((e: any, i: number) => (
                            <div key={i} className="mb-7">
                                <div className="flex justify-between items-baseline mb-0.5">
                                    <span className="text-[13px] font-medium text-gray-800">{e.company}</span>
                                    <span className="text-[9px] text-gray-700  tracking-wider">{e.startDate} – {e.endDate || 'now'}</span>
                                </div>
                                <div className="text-[10px] text-gray-600  mb-2" style={{ color: c }}>{e.position}</div>
                    ...
                    {data.projects?.length > 0 && (
                        <section>
                            <div className="text-[8px] uppercase tracking-[0.35em] text-gray-700  mb-5 font-medium">projects</div>
                            {data.projects.map((p: any, i: number) => (
                                <div key={i} className="mb-4">
                                    <span className="text-[12px] font-medium text-gray-700">{p.name}</span>
                                    <p className="text-[10px] font-light text-gray-600  mt-1 leading-loose">{p.description}</p>
                                </div>
                            ))}
                        </section>
                    )}
                ...
                <div className="col-span-5 space-y-8">
                    <section>
                        <div className="text-[8px] uppercase tracking-[0.35em] text-gray-700  mb-4 font-medium">skills</div>
                        <div className="space-y-1.5">
                            {data.skills.map((s: string, i: number) => (
                    ...
                    <section>
                        <div className="text-[8px] uppercase tracking-[0.35em] text-gray-700  mb-4 font-medium">education</div>
                        {data.education.map((e: any, i: number) => (
                            <div key={i} className="mb-4">
                                <div className="text-[11px] font-medium text-gray-700">{e.school}</div>
                                <div className="text-[10px] font-light text-gray-600 ">{e.degree}</div>
                                <div className="text-[9px] text-gray-700 ">{e.endDate}</div>
                            </div>
                        ))}
                    </section>
                    {data.languages?.length > 0 && (
                        <section>
                            <div className="text-[8px] uppercase tracking-[0.35em] text-gray-700  mb-4 font-medium">languages</div>
                            {data.languages.map((l: any, i: number) => (
                                <div key={i} className="flex justify-between text-[10px] mb-1.5 text-gray-500  font-light">
                                    <span>{l.language}</span><span className="text-gray-700 ">{l.proficiency}</span>
                                </div>
                            ))}
                        </section>
                    )}
                    {data.certifications?.length > 0 && (
                        <section>
                            <div className="text-[8px] uppercase tracking-[0.35em] text-gray-700  mb-4 font-medium">certifications</div>
                            {data.certifications.map((cert: any, i: number) => (
                                <div key={i} className="mb-2">
                                    <div className="text-[10px] font-light text-gray-600">{cert.name}</div>
                                    <div className="text-[9px] text-gray-700 ">{cert.issuer}</div>
                                </div>
                            ))}
                        </section>
                    )}
                    {data.interests?.length > 0 && (
                        <section>
                            <div className="text-[8px] uppercase tracking-[0.35em] text-gray-700  mb-4 font-medium">interests</div>
                            <p className="text-[10px] font-light text-gray-600  leading-loose">{data.interests.join('\n')}</p>
                        </section>
                    )}
                </div>
            </div>
...
const T_Brutal = ({ data, primaryColor: c }: any) => (
    <div className="bg-white w-[794px] min-h-[1123px] resume-page" style={{ fontFamily: 'Space Grotesk, sans-serif', border: '4px solid black' }}>
        <header style={{ background: c, borderBottom: '4px solid black' }} className="p-10">
            <h1 className="text-5xl font-black text-gray-900  uppercase tracking-tighter leading-none">{data.personalInfo.fullName}</h1>
            <div className="mt-3 flex gap-6 text-[11px] font-bold text-gray-900  uppercase tracking-wider">
                <span>{data.personalInfo.email}</span>
        ...
        <div className="flex">
            <div style={{ borderRight: '4px solid black' }} className="w-[220px] flex-shrink-0">
                <div style={{ borderBottom: '3px solid black', background: 'black' }} className="p-4 text-gray-900  text-[9px] font-black uppercase tracking-widest">Skills</div>
                <div className="p-5 flex flex-wrap gap-2">
                    {data.skills.map((s: string, i: number) => (
                        <span key={i} style={{ border: '2px solid black' }} className="px-2 py-1 text-[9px] font-black uppercase">{s}</span>
                    ))}
                </div>
                <div style={{ borderTop: '3px solid black', borderBottom: '3px solid black', background: 'black' }} className="p-4 text-gray-900  text-[9px] font-black uppercase tracking-widest">Education</div>
                ...
                {data.languages?.length > 0 && (
                    <>
                        <div style={{ borderTop: '3px solid black', borderBottom: '3px solid black', background: 'black' }} className="p-4 text-gray-900  text-[9px] font-black uppercase tracking-widest">Languages</div>
                ...
                {data.certifications?.length > 0 && (
                    <>
                        <div style={{ borderTop: '3px solid black', borderBottom: '3px solid black', background: 'black' }} className="p-4 text-gray-900  text-[9px] font-black uppercase tracking-widest">Certifications</div>
                        <div className="p-5 space-y-2">
                            {data.certifications.map((cert: any, i: number) => (
                                <div key={i}>
                ...
                {data.interests?.length > 0 && (
                    <>
                        <div style={{ borderTop: '3px solid black', borderBottom: '3px solid black', background: 'black' }} className="p-4 text-gray-900  text-[9px] font-black uppercase tracking-widest">Interests</div>
                        <div className="p-5">
            ...
            <div className="flex-1 p-8 space-y-6">
                <div style={{ border: '3px solid black' }} className="p-5">
                    <div className="text-[9px] font-black uppercase tracking-widest text-gray-600  mb-2">Summary</div>
                    ...
                    {data.experience.map((e: any, i: number) => (
                        <div key={i} style={{ borderLeft: `4px solid ${c}`, marginBottom: '20px' }} className="pl-4">
                            <div className="flex justify-between items-baseline">
                                ...
                                <span className="text-[9px] font-bold text-gray-600 ">{e.startDate} – {e.endDate || 'Present'}</span>
                            </div>
...
const T_Vogue = ({ data, primaryColor: c }: any) => (
    <div className="bg-white w-[794px] min-h-[1123px] resume-page px-16 py-12" style={{ fontFamily: 'Playfair Display, Georgia, serif' }}>
        <header className="mb-10 grid grid-cols-2 items-end" style={{ borderBottom: `3px solid ${c}`, paddingBottom: '24px' }}>
            <div>
                <div className="text-[9px] tracking-[0.5em] uppercase text-gray-600  mb-2" style={{ fontFamily: 'DM Sans, sans-serif' }}>Curriculum Vitae</div>
        ...
        <div className="grid grid-cols-12 gap-10">
            <div className="col-span-8 space-y-9">
                <section>
                    <h2 className="text-[9px] uppercase tracking-[0.4em] mb-5 text-gray-600 " style={{ fontFamily: 'DM Sans' }}>Career History</h2>
                    {data.experience.map((e: any, i: number) => (
                        <div key={i} className="mb-7 flex gap-6">
                            <div className="w-20 flex-shrink-0 text-right">
                                <div className="text-[9px] text-gray-600  leading-loose" style={{ fontFamily: 'DM Sans' }}>{e.startDate}</div>
                                <div className="text-[9px] text-gray-700 " style={{ fontFamily: 'DM Sans' }}>—</div>
                                <div className="text-[9px] text-gray-600 " style={{ fontFamily: 'DM Sans' }}>{e.endDate || 'Present'}</div>
                            </div>
                            <div className="flex-1 border-l border-gray-100 pl-6">
                                <h3 className="text-xl font-bold italic" style={{ color: c }}>{e.company}</h3>
                                <div className="text-[10px] uppercase tracking-widest text-gray-600  mb-2" style={{ fontFamily: 'DM Sans' }}>{e.position}</div>
                ...
                {data.projects?.length > 0 && (
                    <section>
                        <h2 className="text-[9px] uppercase tracking-[0.4em] mb-5 text-gray-600 " style={{ fontFamily: 'DM Sans' }}>Featured Work</h2>
                        {data.projects.map((p: any, i: number) => (
                            <div key={i} className="mb-5">
            ...
            <div className="col-span-4 space-y-8">
                <section>
                    <h2 className="text-[9px] uppercase tracking-[0.4em] mb-4 text-gray-600 " style={{ fontFamily: 'DM Sans' }}>Education</h2>
                    {data.education.map((e: any, i: number) => (
                        <div key={i} className="mb-4">
                            ...
                            <div className="text-[9px] text-gray-600 " style={{ fontFamily: 'DM Sans' }}>{e.fieldOfStudy} · {e.endDate}</div>
                        </div>
                    ))}
                </section>
                <section>
                    <h2 className="text-[9px] uppercase tracking-[0.4em] mb-4 text-gray-600 " style={{ fontFamily: 'DM Sans' }}>Expertise</h2>
                    <div className="space-y-1.5">
                        {data.skills.map((s: string, i: number) => (
                ...
                {data.languages?.length > 0 && (
                    <section>
                        <h2 className="text-[9px] uppercase tracking-[0.4em] mb-4 text-gray-600 " style={{ fontFamily: 'DM Sans' }}>Languages</h2>
                        {data.languages.map((l: any, i: number) => (
                            <div key={i} className="flex justify-between text-[11px] mb-1">
                                <span className="italic">{l.language}</span>
                                <span className="text-[9px] text-gray-600 " style={{ fontFamily: 'DM Sans' }}>{l.proficiency}</span>
                            </div>
                        ))}
                    </section>
                )}
                {data.certifications?.length > 0 && (
                    <section>
                        <h2 className="text-[9px] uppercase tracking-[0.4em] mb-4 text-gray-600 " style={{ fontFamily: 'DM Sans' }}>Certifications</h2>
                        {data.certifications.map((cert: any, i: number) => (
                            <div key={i} className="mb-2">
                                <div className="text-[11px] italic">{cert.name}</div>
                                <div className="text-[9px] text-gray-600 " style={{ fontFamily: 'DM Sans' }}>{cert.issuer} · {cert.date}</div>
                            </div>
                        ))}
                    </section>
                )}
                {data.interests?.length > 0 && (
                    <section>
                        <h2 className="text-[9px] uppercase tracking-[0.4em] mb-4 text-gray-600 " style={{ fontFamily: 'DM Sans' }}>Passions</h2>
...
const T_Tech = ({ data, primaryColor: c }: any) => (
    <div className="bg-white w-[794px] min-h-[1123px] resume-page" style={{ fontFamily: 'JetBrains Mono, monospace' }}>
        <header className="bg-gray-950 text-green-400 px-12 py-8">
            ...
            <div className="mt-4 grid grid-cols-2 gap-2 text-[9px] text-gray-600 ">
        ...
        <div className="flex gap-0">
                    ...
                    <section>
                        ...
                        {data.projects.map((p: any, i: number) => (
                            <div key={i} className="mb-4 p-3 bg-gray-50 rounded border border-gray-100">
                                <div className="text-[10px] font-bold text-gray-800">{p.name}</div>
                                {p.link && <div className="text-[9px] text-gray-600  mb-1">{p.link}</div>}
            ...
            <div className="w-52 bg-gray-50 border-l border-gray-100 p-6 space-y-6">
                <section>
                    <div className="text-[9px] font-bold uppercase tracking-widest mb-3 text-gray-600 ">// skills</div>
                    {data.skills.map((s: string, i: number) => (
                ...
                <section>
                    <div className="text-[9px] font-bold uppercase tracking-widest mb-3 text-gray-600 ">// education</div>
                    {data.education.map((e: any, i: number) => (
                        <div key={i} className="mb-3">
                            <div className="text-[9px] font-bold text-gray-700">{e.school}</div>
                            <div className="text-[8px] text-gray-500 ">{e.degree}</div>
                            <div className="text-[8px] text-gray-600 ">{e.endDate}</div>
                        </div>
                    ))}
                </section>
                {data.languages?.length > 0 && (
                    <section>
                        <div className="text-[9px] font-bold uppercase tracking-widest mb-3 text-gray-600 ">// languages</div>
                        {data.languages.map((l: any, i: number) => (
                            <div key={i} className="text-[9px] text-gray-600 mb-1">
                                {l.language}: <span className="text-gray-600 ">{l.proficiency}</span>
                            </div>
                        ))}
                    </section>
                )}
                {data.certifications?.length > 0 && (
                    <section>
                        <div className="text-[9px] font-bold uppercase tracking-widest mb-3 text-gray-600 ">// certs</div>
                        {data.certifications.map((cert: any, i: number) => (
                            <div key={i} className="mb-2">
                                <div className="text-[8px] font-bold text-gray-700">{cert.name}</div>
                                <div className="text-[8px] text-gray-600 ">{cert.issuer}</div>
                            </div>
                        ))}
                    </section>
                )}
                {data.awards?.length > 0 && (
                    <section>
                        <div className="text-[9px] font-bold uppercase tracking-widest mb-3 text-gray-600 ">// awards</div>
                        {data.awards.map((a: any, i: number) => (
                            <div key={i} className="mb-2">
                                <div className="text-[8px] font-bold text-gray-700">{a.title}</div>
                                <div className="text-[8px] text-gray-600 ">{a.date}</div>
                            </div>
                        ))}
                    </section>
                )}
                {data.interests?.length > 0 && (
                    <section>
                        <div className="text-[9px] font-bold uppercase tracking-widest mb-3 text-gray-600 ">// interests</div>
                ...
                <section>
                    ...
                    {data.education.map((e: any, i: number) => (
                        <div key={i} className="mb-4 pl-3 border-l-2" style={{ borderColor: `${c}30` }}>
                            ...
                            <div className="text-[9px] text-gray-500 ">{e.degree}</div>
                            <div className="text-[9px] text-gray-600 ">{e.endDate}</div>
                        </div>
                    ))}
                </section>
                <section>
                    ...
                    <div className="flex flex-wrap gap-1.5">
                        {data.skills.map((s: string, i: number) => (
                            <span key={i} className="text-[8px] px-2 py-0.5 rounded-full font-bold text-gray-900 " style={{ background: c }}>{s}</span>
                        ))}
                    </div>
                </section>
                {data.languages?.length > 0 && (
                ...
                {data.certifications?.length > 0 && (
                    <section>
                        ...
                        {data.certifications.map((cert: any, i: number) => (
                            <div key={i} className="mb-2">
                                <div className="text-[9px] font-bold text-gray-700">{cert.name}</div>
                                <div className="text-[8px] text-gray-600 ">{cert.issuer} · {cert.date}</div>
                            </div>
                        ))}
                    </section>
                )}
                {data.awards?.length > 0 && (
                    <section>
                        ...
                        {data.awards.map((a: any, i: number) => (
                            <div key={i} className="mb-2">
                                <div className="text-[9px] font-bold text-gray-700">{a.title}</div>
                                <div className="text-[8px] text-gray-600 ">{a.issuer} · {a.date}</div>
                            </div>
                        ))}
                    </section>
                )}
...
const T_Gradient = ({ data, primaryColor: c }: any) => (
    <div className="bg-white w-[794px] min-h-[1123px] resume-page" style={{ fontFamily: 'DM Sans, sans-serif' }}>
        <header className="px-14 py-10 text-gray-900  relative overflow-hidden" style={{ background: `linear-gradient(135deg, ${c} 0%, ${c}88 100%)` }}>
            <div className="relative z-10">
                <h1 className="text-4xl font-black tracking-tight">{data.personalInfo.fullName}</h1>
                <p className="text-gray-900  font-medium mt-1">{data.experience[0]?.position}</p>
                <p className="text-gray-900  text-[11px] mt-3 max-w-lg leading-relaxed">{data.personalInfo.summary}</p>
                <div className="flex flex-wrap gap-6 mt-4 text-[10px] text-gray-900 ">
                    <span>✉ {data.personalInfo.email}</span>
                    <span>☎ {data.personalInfo.phone}</span>
                    <span>⌖ {data.personalInfo.address}</span>
...
const T_Slate = ({ data, primaryColor: c }: any) => (
    <div className="bg-white w-[794px] min-h-[1123px] resume-page flex" style={{ fontFamily: 'Inter, sans-serif' }}>
        <aside className="w-[230px] bg-slate-800 text-gray-900  p-8 flex flex-col gap-7">
            <div>
        ...
        <div className="flex h-full">
            <div className="w-[280px] flex-shrink-0">
                <div className="p-8 pb-6" style={{ background: c }}>
                    <h1 className="text-3xl font-black text-gray-900  tracking-tighter leading-tight">{data.personalInfo.fullName}</h1>
                    <p className="text-[10px] text-gray-900  mt-2 uppercase tracking-widest font-medium">{data.experience[0]?.position}</p>
                </div>
                <div className="bg-gray-900 p-8 space-y-6">
                    ...
                    <div>
                        ...
                        {data.education.map((e: any, i: number) => (
                            <div key={i} className="mb-3">
                                <div className="text-[10px] font-bold text-gray-900 ">{e.school}</div>
                                <div className="text-[9px] text-gray-600 ">{e.degree}, {e.fieldOfStudy}</div>
                    ...
                    {data.interests?.length > 0 && (
                        <div>
                            ...
                            <p className="text-[9px] text-gray-600  leading-loose">{data.interests.join(' · ')}</p>
                        </div>
                    )}
                </div>
            </div>
    ...
    <div className="bg-white w-[794px] min-h-[1123px] resume-page" style={{ fontFamily: 'DM Sans, sans-serif' }}>
        <header className="bg-black px-12 py-8">
            <div className="flex justify-between items-end">
                <div>
                    <h1 className="text-5xl font-black text-gray-900  leading-none tracking-tighter">{data.personalInfo.fullName.split(' ')[0]}</h1>
                ...
                <div className="text-right text-[10px] text-gray-600  space-y-0.5">
                    ...
                    <div>{data.personalInfo.phone}</div>
                    <div>{data.personalInfo.address}</div>
                    {data.personalInfo.linkedin && <div className="text-gray-900 ">{data.personalInfo.linkedin}</div>}
                </div>
            </div>
        </header>
        <div className="flex">
                    ...
                    {data.experience.map((e: any, i: number) => (
                        <div key={i} className="mb-5">
                            <div className="grid grid-cols-4">
                                ...
                                <div className="text-right text-[9px] text-gray-600 ">{e.startDate}<br />{e.endDate || 'Present'}</div>
                            </div>
                    ...
                    {data.experience.map((e: any, i: number) => (
                        <div key={i} className="mb-5 grid grid-cols-4">
                            <div className="col-span-1 text-right pr-4 pt-0.5">
                                <div className="text-[9px] text-gray-600  uppercase leading-loose">{e.startDate}</div>
                                <div className="text-[9px] text-gray-600 ">–</div>
                                <div className="text-[9px] text-gray-600 ">{e.endDate || 'now'}</div>
                            </div>
                        ...
                        {data.projects.map((p: any, i: number) => (
                            <div key={i} className="mb-4 grid grid-cols-4">
                                <div className="col-span-1 text-right pr-4">
                                    <div className="text-[9px] text-gray-600  uppercase">{i + 1 < 10 ? '0' : ''}{i + 1}</div>
                                </div>
                                <div className="col-span-3 border-l-2 border-gray-200 pl-4">
            ...
            <div className="col-span-4 space-y-7">
                ...
                {(data.awards?.length > 0 || data.interests?.length > 0) && (
                    <section>
                        ...
                        {data.interests && <p className="text-[9px] text-gray-600  mt-2 leading-loose">{data.interests.join(' · ')}</p>}
                    </section>
                )}
            </div>
        </div>
                    ...
                    {data.experience.map((e: any, i: number) => (
                        <div key={i} className="mb-3">
                            <div className="flex justify-between">
                                ...
                                <span className="text-[8px] text-gray-600 ">{e.startDate} – {e.endDate || 'Present'}</span>
                            </div>
            ...
            <div className="col-span-4 space-y-5">
                ...
                {data.languages?.length > 0 && (
                    <section>
                        ...
                        {data.languages.map((l: any, i: number) => (
                            <div key={i} className="text-[10px] text-gray-600 mb-0.5">{l.language} — <span className="text-gray-600 ">{l.proficiency}</span></div>
                        ))}
                    </section>
                )}
                {data.interests?.length > 0 && (
...
const T_Bold = ({ data, primaryColor: c }: any) => (
    <div className="bg-gray-950 w-[794px] min-h-[1123px] resume-page" style={{ fontFamily: 'Outfit, sans-serif' }}>
        <header className="px-12 pt-10 pb-8 relative overflow-hidden">
            <div className="absolute top-4 right-0 max-w-full overflow-hidden text-[80px] font-black text-gray-100  leading-none select-none pointer-events-none uppercase tracking-tighter opacity-50">
                {data.personalInfo.fullName.split(' ')[0]}
            </div>
            <div className="relative z-10">
                <h1 className="text-5xl font-black text-gray-900  leading-none">{data.personalInfo.fullName}</h1>
        ...
        <div className="px-12 pb-12">
            <p className="text-[11px] text-gray-600  leading-relaxed mb-8 pb-8 border-b border-gray-200 ">{data.personalInfo.summary}</p>
            <div className="grid grid-cols-12 gap-8">
                <div className="col-span-8 space-y-8">
                    <section>
                        ...
                        {data.experience.map((e: any, i: number) => (
                            <div key={i} className="mb-6 pl-4" style={{ borderLeft: `2px solid ${c}` }}>
                                <div className="flex justify-between">
                                    <span className="font-black text-gray-900  text-sm uppercase">{e.company}</span>
                                    <span className="text-[9px] text-gray-500 ">{e.startDate} – {e.endDate || 'Present'}</span>
                                </div>
                                <div className="text-[10px] font-semibold mb-2 text-gray-600 ">{e.position}</div>
                                <p className="text-[10px] text-gray-500  leading-relaxed">{e.description}</p>
                            </div>
                        ))}
                    </section>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                {data.projects.map((p: any, i: number) => (
                                    <div key={i} className="p-4 rounded-lg bg-gray-100  border border-gray-200 ">
                                        <div className="text-[10px] font-black text-gray-900  uppercase mb-1">{p.name}</div>
                                        <p className="text-[9px] text-gray-500  leading-relaxed">{p.description}</p>
                                    </div>
                                ))}
                            </div>
                ...
                <div className="col-span-4 space-y-6">
                    <section>
                        ...
                        <div className="flex flex-wrap gap-2">
                            {data.skills.map((s: string, i: number) => (
                                <span key={i} className="text-[8px] px-2 py-0.5 rounded text-gray-900  font-bold" style={{ background: `${c}20`, border: `1px solid ${c}40` }}>{s}</span>
                            ))}
                        </div>
                    </section>
                    <section>
                        ...
                        {data.education.map((e: any, i: number) => (
                            <div key={i} className="mb-3">
                                <div className="text-[10px] font-bold text-gray-900 ">{e.school}</div>
                                <div className="text-[9px] text-gray-600 ">{e.degree}</div>
                                <div className="text-[9px] text-gray-500 ">{e.endDate}</div>
                            </div>
                        ))}
                    </section>
    ...
    <div className="w-[794px] min-h-[1123px] resume-page p-10" style={{ fontFamily: 'DM Sans, sans-serif', background: '#f8f7f5' }}>
        <div className="rounded-3xl bg-white shadow-sm p-10 mb-6">
            <div className="flex justify-between items-start">
                ...
                <div className="text-right text-[10px] text-gray-600  space-y-1 flex-shrink-0 ml-6">
                    <div>{data.personalInfo.email}</div>
                    <div>{data.personalInfo.phone}</div>
                    <div>{data.personalInfo.address}</div>
                    {data.personalInfo.linkedin && <div>{data.personalInfo.linkedin}</div>}
    ...
    <div className="bg-white w-[794px] min-h-[1123px] resume-page" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
        <header className="grid grid-cols-12">
            <div className="col-span-8 p-10 pb-6" style={{ background: c }}>
                <h1 className="text-5xl font-black text-gray-900  tracking-tight leading-none">{data.personalInfo.fullName}</h1>
                <p className="text-gray-900  text-sm mt-2 font-medium uppercase tracking-wider">{data.experience[0]?.position}</p>
            </div>
            <div className="col-span-4 bg-gray-900 p-8 flex flex-col justify-center">
                <div className="text-[9px] text-gray-600  space-y-1.5">
                    <div>{data.personalInfo.email}</div>
                    <div>{data.personalInfo.phone}</div>
                    <div>{data.personalInfo.address}</div>
                    {data.personalInfo.linkedin && <div>{data.personalInfo.linkedin}</div>}
        ...
        <div className="grid grid-cols-12">
            <main className="col-span-8 p-10 space-y-7 border-r border-gray-100">
                <section>
                    <div className="flex items-center gap-0 mb-4">
                        <div className="px-3 py-1 text-gray-900  text-[9px] font-black uppercase tracking-widest" style={{ background: c }}>Profile</div>
                ...
                <section>
                    <div className="flex items-center gap-0 mb-4">
                        <div className="px-3 py-1 text-gray-900  text-[9px] font-black uppercase tracking-widest" style={{ background: c }}>Experience</div>
                        <div className="flex-1 h-px bg-gray-100" />
                    </div>
                    {data.experience.map((e: any, i: number) => (
                        <div key={i} className="mb-5">
                ...
                {data.projects?.length > 0 && (
                    <section>
                        <div className="flex items-center gap-0 mb-4">
                            <div className="px-3 py-1 text-gray-900  text-[9px] font-black uppercase tracking-widest" style={{ background: c }}>Projects</div>
                            <div className="flex-1 h-px bg-gray-100" />
                        </div>
                        <div className="grid grid-cols-2 gap-4">
                            {data.projects.map((p: any, i: number) => (
                ...
                {data.awards?.length > 0 && (
                    <section>
                        <div className="flex items-center gap-0 mb-4">
                            <div className="px-3 py-1 text-gray-900  text-[9px] font-black uppercase tracking-widest" style={{ background: c }}>Awards</div>
                            <div className="flex-1 h-px bg-gray-100" />
                        </div>
                        {data.awards.map((a: any, i: number) => (
                            <div key={i} className="flex justify-between text-[10px] mb-1.5">
            ...
            <aside className="col-span-4 p-8 space-y-6">
                <section>
                    <div className="text-[9px] font-black uppercase tracking-widest text-gray-900  px-2 py-0.5 inline-block mb-3" style={{ background: c }}>Skills</div>
                    <div className="flex flex-wrap gap-1.5">
                        {data.skills.map((s: string, i: number) => (
                ...
                <section>
                    <div className="text-[9px] font-black uppercase tracking-widest text-gray-900  px-2 py-0.5 inline-block mb-3" style={{ background: c }}>Education</div>
                    {data.education.map((e: any, i: number) => (
                        <div key={i} className="mb-3">
                ...
                {data.languages?.length > 0 && (
                    <section>
                        <div className="text-[9px] font-black uppercase tracking-widest text-gray-900  px-2 py-0.5 inline-block mb-3" style={{ background: c }}>Languages</div>
                        {data.languages.map((l: any, i: number) => (
                            <div key={i} className="flex justify-between text-[10px] mb-1">
                                <span className="font-medium text-gray-700">{l.language}</span>
                                <span className="text-gray-600 ">{l.proficiency}</span>
                ...
                {data.certifications?.length > 0 && (
                    <section>
                        <div className="text-[9px] font-black uppercase tracking-widest text-gray-900  px-2 py-0.5 inline-block mb-3" style={{ background: c }}>Certifications</div>
                        {data.certifications.map((cert: any, i: number) => (
                            <div key={i} className="mb-2">
                                <div className="text-[9px] font-bold text-gray-700">{cert.name}</div>
                                <div className="text-[8px] text-gray-600 ">{cert.issuer} · {cert.date}</div>
                ...
                {data.interests?.length > 0 && (
                    <section>
                        <div className="text-[9px] font-black uppercase tracking-widest text-gray-900  px-2 py-0.5 inline-block mb-3" style={{ background: c }}>Interests</div>
                        <p className="text-[9px] text-gray-500 ">{data.interests.join(' · ')}</p>
                    </section>
                )}
            </aside>
    ...
    <div className="bg-white w-[794px] min-h-[1123px] resume-page flex" style={{ fontFamily: 'DM Sans, sans-serif' }}>
        <main className="flex-1 p-12 space-y-8">
            <header>
                ...
                <p className="text-[10px] uppercase tracking-[0.3em] text-gray-600 ">{data.experience[0]?.position}</p>
            </header>
            <section>
                <p className="text-[12px] text-gray-500  leading-loose font-light">{data.personalInfo.summary}</p>
            </section>
            <section>
                <h2 className="text-[8px] uppercase tracking-[0.4em] text-gray-700  mb-5">Work History</h2>
                {data.experience.map((e: any, i: number) => (
                    <div key={i} className="mb-6">
                        <div className="flex justify-between items-baseline mb-0.5">
                            <span className="text-[14px] font-semibold text-gray-800">{e.company}</span>
                            <span className="text-[9px] text-gray-700  tracking-wider">{e.startDate} – {e.endDate || 'Present'}</span>
                        </div>
            ...
            {data.projects?.length > 0 && (
                <section>
                    <h2 className="text-[8px] uppercase tracking-[0.4em] text-gray-700  mb-5">Projects</h2>
                    {data.projects.map((p: any, i: number) => (
                        <div key={i} className="mb-4">
                            <span className="text-[13px] font-semibold text-gray-700">{p.name}</span>
                            <p className="text-[10px] text-gray-600  mt-0.5 font-light leading-loose">{p.description}</p>
                        </div>
                    ))}
                </section>
            )}
        ...
        <aside className="w-[200px] bg-gray-50 p-8 space-y-7 border-l border-gray-100">
            <div className="text-[10px] text-gray-500  space-y-1.5">
                ...
                <div>{data.personalInfo.phone}</div>
                <div>{data.personalInfo.address}</div>
                {data.personalInfo.linkedin && <div className="text-gray-600 ">{data.personalInfo.linkedin}</div>}
            </div>
            <section>
                <h2 className="text-[8px] uppercase tracking-[0.4em] text-gray-700  mb-4">Education</h2>
                {data.education.map((e: any, i: number) => (
                    <div key={i} className="mb-3">
                        <div className="text-[10px] font-semibold text-gray-700">{e.school}</div>
                        <div className="text-[9px] text-gray-600  font-light">{e.degree}</div>
                        <div className="text-[9px] text-gray-700 ">{e.endDate}</div>
                    </div>
                ))}
            </section>
            <section>
                <h2 className="text-[8px] uppercase tracking-[0.4em] text-gray-700  mb-4">Skills</h2>
                <div className="space-y-1.5">
                    {data.skills.map((s: string, i: number) => (
            ...
            {data.languages?.length > 0 && (
                <section>
                    <h2 className="text-[8px] uppercase tracking-[0.4em] text-gray-700  mb-4">Languages</h2>
                    {data.languages.map((l: any, i: number) => (
            ...
            {data.certifications?.length > 0 && (
                <section>
                    <h2 className="text-[8px] uppercase tracking-[0.4em] text-gray-700  mb-4">Certifications</h2>
                    {data.certifications.map((cert: any, i: number) => (
                        <div key={i} className="mb-2">
                            <div className="text-[9px] text-gray-600 font-medium">{cert.name}</div>
                            <div className="text-[8px] text-gray-600 ">{cert.date}</div>
                        </div>
                    ))}
                </section>
            )}
            {(data.awards?.length > 0 || data.interests?.length > 0) && (
                <section>
                    <h2 className="text-[8px] uppercase tracking-[0.4em] text-gray-700  mb-4">More</h2>
                    {data.awards?.map((a: any, i: number) => (
                        <div key={i} className="text-[9px] text-gray-500  font-medium mb-1">{a.title}</div>
                    ))}
                    {data.interests && <p className="text-[9px] text-gray-600  font-light mt-2 leading-loose">{data.interests.join(' · ')}</p>}
                </section>
            )}
        </aside>
    </div>
    ...
    <div className="bg-gray-50 w-[794px] min-h-[1123px] resume-page flex" style={{ fontFamily: 'Inter, sans-serif' }}>
        <aside className="w-[220px] bg-white border-r border-gray-100 p-8 flex flex-col gap-6">
            ...
            <div className="text-[9px] text-gray-500  space-y-1">
                ...
                <div>{data.personalInfo.phone}</div>
                <div>{data.personalInfo.address}</div>
                {data.personalInfo.github && <div className="text-gray-600 ">{data.personalInfo.github}</div>}
                {data.personalInfo.linkedin && <div className="text-gray-600 ">{data.personalInfo.linkedin}</div>}
            </div>
            <div>
                <div className="text-[8px] font-black uppercase tracking-widest text-gray-600  mb-2">Tech Stack</div>
                <div className="flex flex-wrap gap-1.5">
                    {data.skills.map((s: string, i: number) => (
            ...
            <div>
                <div className="text-[8px] font-black uppercase tracking-widest text-gray-600  mb-3">Education</div>
                {data.education.map((e: any, i: number) => (
            ...
            {data.languages?.length > 0 && (
                <div>
                    <div className="text-[8px] font-black uppercase tracking-widest text-gray-600  mb-2">Languages</div>
                    {data.languages.map((l: any, i: number) => (
            ...
            {data.certifications?.length > 0 && (
                <div>
                    <div className="text-[8px] font-black uppercase tracking-widest text-gray-600  mb-2">Certifications</div>
                    {data.certifications.map((cert: any, i: number) => (
                        <div key={i} className="mb-1.5">
                            <div className="text-[8px] font-bold text-gray-700">{cert.name}</div>
                            <div className="text-[7px] text-gray-600 ">{cert.issuer} · {cert.date}</div>
                        </div>
                    ))}
                </div>
            )}
            {data.interests?.length > 0 && (
                <div>
                    <div className="text-[8px] font-black uppercase tracking-widest text-gray-600  mb-2">Interests</div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        {data.projects.map((p: any, i: number) => (
                            <div key={i} className="bg-white rounded-lg p-4 border border-gray-100">
                                ...
                                {p.link && <div className="text-[8px] text-gray-600  mb-1">{p.link}</div>}
                                <p className="text-[9px] text-gray-500  leading-relaxed">{p.description}</p>
                                {p.technologies?.length > 0 && (
                                    <div className="flex flex-wrap gap-1 mt-2">
                                        {p.technologies.map((t: string, ti: number) => (
        ...
        {[
            {
                title: 'Research & Professional Experience', rows: data.experience.map((e: any, i: number) => (
                    <div key={i} className="mb-4 flex gap-4">
                        <div className="w-20 text-right text-[10px] text-gray-600  italic flex-shrink-0 pt-0.5">{e.startDate}<br />–<br />{e.endDate || 'present'}</div>
            ...
            },
            {
                title: 'Education', rows: data.education.map((e: any, i: number) => (
                    <div key={i} className="mb-3 flex justify-between">
                        ...
                        <div className="text-[10px] text-gray-600  italic text-right">{e.startDate}–{e.endDate}</div>
                    </div>
                ))
            },
        ].map(({ title, rows }, si) => (
...
const T_AiryProfessional = ({ data, primaryColor: c }: any) => (
    <div className="bg-white w-[794px] min-h-[1123px] resume-page px-20 py-14" style={{ fontFamily: 'DM Sans, sans-serif' }}>
        <header className="mb-12">
            <div className="flex justify-between items-end">
                <div>
                    <p className="text-[9px] uppercase tracking-[0.4em] text-gray-600  mb-2">Curriculum Vitae</p>
            ...
            <div className="mt-5 flex items-center gap-4">
                ...
                <p className="text-[10px] font-medium text-gray-600  uppercase tracking-widest">{data.experience[0]?.position}</p>
                <div className="h-0.5 flex-1 bg-gray-100" />
            </div>
        </header>
                ...
                {data.experience.map((e: any, i: number) => (
                    <div key={i} className="mb-7 grid grid-cols-12 gap-4">
                        <div className="col-span-3 text-right">
                            <p className="text-[9px] text-gray-600  leading-loose">{e.startDate}</p>
                            <p className="text-[9px] text-gray-700 ">—</p>
                            <p className="text-[9px] text-gray-600 ">{e.endDate || 'Present'}</p>
                        </div>
                ...
                <section>
                    ...
                    {data.languages?.map((l: any, i: number) => (
                        <div key={i} className="flex justify-between text-[11px] font-light text-gray-600 mb-1.5">
                            <span>{l.language}</span><span className="text-gray-600 ">{l.proficiency}</span>
                        </div>
                    ))}
                </section>
                <section>
        ...
        <div className="grid grid-cols-12 gap-10">
            <main className="col-span-8 space-y-7">
                {[
                    ...
                    <section key={si}>
                        <h2 className="text-[9px] font-semibold uppercase tracking-[0.25em] text-gray-600  mb-3">{label}</h2>
                        {content}
                    </section>
                ))}
            </main>
...
const T_CompactModern = ({ data, primaryColor: c }: any) => (
    <div className="bg-white w-[794px] min-h-[1123px] resume-page" style={{ fontFamily: 'Inter, sans-serif' }}>
        <header className="px-10 py-7" style={{ background: `linear-gradient(to right, ${c}, ${c}cc)` }}>
            <div className="flex justify-between items-end">
                <div>
                    <h1 className="text-3xl font-black text-gray-900  tracking-tight">{data.personalInfo.fullName}</h1>
                    <p className="text-gray-900  text-[11px] mt-0.5 font-medium">{data.experience[0]?.position}</p>
                </div>
                <div className="text-right text-[9px] text-gray-900  space-y-0.5">
                    <div>{data.personalInfo.email}</div>
                    <div>{data.personalInfo.phone}</div>
                    <div>{data.personalInfo.address}</div>
                    {data.personalInfo.linkedin && <div>{data.personalInfo.linkedin}</div>}
...
const T_Hybrid = ({ data, primaryColor: c }: any) => (
    <div className="bg-white w-[794px] min-h-[1123px] resume-page" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
        <header className="px-12 pt-10 pb-7 bg-gray-950">
            <div className="flex justify-between items-end">
                <div>
                    <h1 className="text-4xl font-black text-gray-900  tracking-tighter">{data.personalInfo.fullName}</h1>
                    <p className="text-sm font-medium mt-1" style={{ color: c }}>{data.experience[0]?.position}</p>
                </div>
            ...
            <div className="grid grid-cols-3 gap-4 mt-6 pt-5 border-t border-gray-200 ">
                ...
                <div>
                    ...
                    {data.languages?.map((l: any, i: number) => <div key={i} className="text-[9px] text-gray-600 ">{l.language} — {l.proficiency}</div>)}
                </div>
            </div>
        </header>
...
export default function ResumeTemplate({ data, template, primaryColor = '#3b82f6' }: ResumeTemplateProps) {
    ...
    const marginMap = { compact: '-1rem', normal: '0rem', spacious: '1.5rem' };
    const sizeMap = { A4: { w: '210mm', h: '297mm' }, LETTER: { w: '8.5in', h: '11in' } };
    const pageW = styling?.pageSize ? sizeMap[styling.pageSize].w : '794px';
    const minH = styling?.pageSize ? sizeMap[styling.pageSize].h : '1123px';
    const customStyles = styling ? `
        .resume-page { 
            font-family: '${styling.sectionFonts.body}', sans-serif !important; 
            line-height: ${styling.lineHeight || 1.5} !important;
            padding: calc(1rem + ${marginMap[styling.margins || 'normal']}) !important;
            width: ${pageW} !important;
            min-height: ${minH} !important;
        }
        .resume-page h1 { font-family: '${styling.sectionFonts.name}', sans-serif !important; font-size: ${styling.fontSize.name}px !important; }
        .resume-page h2 { font-family: '${styling.sectionFonts.headings}', sans-serif !important; font-size: ${styling.fontSize.headings}px !important; }
        /* Apply body size strictly to text elements to avoid breaking structural divs */
        .resume-page p, .resume-page span, .resume-page li { font-size: ${styling.fontSize.body}px; }
    ` : '';
